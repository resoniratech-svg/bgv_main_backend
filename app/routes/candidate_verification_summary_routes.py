...
from app.repositories.candidate_verification_summary_repository import CandidateVerificationSummaryRepository
from app.services.candidate_verification_summary_service import (
    CandidateVerificationSummaryService
)

verification_summary_bp = Blueprint(
