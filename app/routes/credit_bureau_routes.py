...
credit_bureau_bp = Blueprint("credit_bureau", __name__)
...
def get_credit_bureau_result(candidate_id):
    ...
    try:
        ...
        result = CreditBureauService.get_result(candidate_id, token)
...
@credit_bureau_bp.route("/decision", methods=["POST"])
@jwt_required()
def save_credit_bureau_decision():
    ...
    try:
        ...
        result = CreditBureauService.save_decision(data)
