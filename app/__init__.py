...
from app.routes.employment_routes import (
    employment_bp
)
...
def create_app():
    ...
    app.register_blueprint(verification_type_bp, url_prefix="/api/v1/verification-types")
    ...
    url_prefix="/api/v1/credit-bureau"
